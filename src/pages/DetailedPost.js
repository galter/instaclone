...
import { post as postsData } from '../data'
...
const DetailedPost = () => {
  ...
  useEffect(() => {
    ...
    setComments(postsData.data.comments)
    setLikes(postsData.data.likesCount)
    setLoading(false)
    setDeadend(false)
  }, [postId])
    ...
    <Wrapper>
      ...
      <div className="post-info">
        <div className="post-header-wrapper">
          ...
          {post.isMine && (
            <FiMoreHorizontal size="1.6em" onClick={() => setShowModal(true)} />
          )}
